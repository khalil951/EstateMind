...
from src.agents.agent_source_runner import SAMPLE_SOURCES, discover_listing_urls
...
def create_agent_api(listing_graph: Any | None = None, db_path: Path | None = None) -> FastAPI:
    ...
    if listing_graph is None:
        from src.agents.listing_graph_factory import build_default_listing_graph
