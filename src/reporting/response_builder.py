...
def build_response(
    ...
    nlp_sentiment_tokens: list[dict[str, Any]],
    nlp_quality_tokens: list[dict[str, Any]],
    location_comparison: dict[str, Any],
    prediction_mode: str,
    ...
    return {
        ...
        "nlp_sentiment_tokens": nlp_sentiment_tokens,
        "nlp_quality_tokens": nlp_quality_tokens,
